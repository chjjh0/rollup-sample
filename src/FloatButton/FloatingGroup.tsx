...
const RootButtonWrapper = styled.div<ButtonWrapperContainer>`
  ...
  -webkit-transform: ${({ isSpread }) =>
    isSpread ? "rotate(135deg)" : "none"};
`;
...
const ItemButton = styled.li<ItemButtonStyleProps>`
  ...
  top: ${({ direction, isSpread, order }) =>
    direction === Direction.BOTTOM && isSpread
      ? order * 80
      : direction === Direction.TOP && isSpread
      ? order * -80
      : 0}px;
  right: ${({ direction, isSpread, order }) =>
    direction === Direction.LEFT && isSpread
      ? order * 80
      : direction === Direction.RIGHT && isSpread
      ? order * -80
      : 0}px;
